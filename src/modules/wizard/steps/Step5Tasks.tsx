  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: hasTasks ? 24 : 0 }}>
        {/* Todoist tile */}
        <div style={{ flex: 1, padding: 20, borderRadius: 12, background: 'var(--color-surface,#161929)', border: '1px solid var(--color-border,#252A3E)' }}>
          ...
          {!TODOIST_CONFIGURED && !data.todoistToken && (
            <div style={{ marginBottom: 12 }}>
              ...
              <input
                ...
                style={{ background: 'var(--color-bg,#0D0F1A)', border: '1px solid var(--color-border,#252A3E)', borderRadius: 7, padding: '8px 12px', color: 'var(--color-text,#E8EAF6)', fontSize: 12, outline: 'none', width: '100%', boxSizing: 'border-box', marginBottom: 8 }}
              />
              <button
        ...
        {/* Trello tile */}
        <div style={{ flex: 1, padding: 20, borderRadius: 12, background: 'var(--color-surface,#161929)', border: '1px solid var(--color-border,#252A3E)', opacity: 0.6 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
        ...
        <div>
          ...
          <div style={{ maxHeight: 260, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 4, paddingRight: 4 }}>
            {data.importedTasks.map(t => (
              <label key={t.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 8, background: 'var(--color-surface,#161929)', border: '1px solid var(--color-border,#252A3E)', cursor: 'pointer' }}>
